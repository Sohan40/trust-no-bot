    ...
    <main className="min-h-screen overflow-hidden">
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-between px-5 py-6 sm:px-8 lg:px-10">
        ...
        <div className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[1fr_0.82fr]">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[#c8d0df]">
              Enter a tense group chat with six AI characters. One has a
              secret role, everyone has a story, and your vote decides who
              survives the round.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <StartGameButton className="focus-ring inline-flex min-h-12 items-center justify-center rounded-md bg-[#e3b75f] px-6 text-base font-bold text-[#12100a] shadow-lg shadow-[#e3b75f]/20 transition hover:bg-[#f0c873] disabled:cursor-wait disabled:opacity-70" />
              <a
          ...
          >
            ...
            <div className="relative grid h-full grid-cols-2 gap-3 pt-4">
              {["Arjun", "Riya", "Kabir", "Meera", "Tara", "Dev"].map(
                (name, index) => (
                  <div
        ...
        <p className="max-w-3xl pb-2 text-sm leading-6 text-[#8f9bb0]">
          Classic games are saved to your anonymous session, so refreshing
          the room keeps your progress. Dialogue is mocked for this milestone.
        </p>
      </section>
    </main>
  );
